class library{
    ...
    public void returnbook(){
        if(bb>0){
            bb--;
            System.out.println(name+"you returned a book Remaining borrowed books:"+bb);
        }else{
  ...
  public class LibrarySystemreturn{
...
/* LalithaNo books to return!
AmarNo books to return!
AmarNo books to return!
Dr.Prem KumarNo books to return! */